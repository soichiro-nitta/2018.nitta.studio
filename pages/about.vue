<template lang="pug">
  .about(
    ...
    .separator
    .section
      .intro 高卒。受託会社のインターンを経てすぐに独立。起業してサービスをつくろうと思い立ち、はや6年。デザインとエンジニアリングを両立してきました。ほとんどデザインをデータにおこすことはなく、コードを書きながらデザインしていきます。制作の全行程を１人の人間がおこなうことで、細かなインタラクティブや、高い品質を提供することができます。
      .thumb
        img(
          :src='src'
          ref='thumb'
